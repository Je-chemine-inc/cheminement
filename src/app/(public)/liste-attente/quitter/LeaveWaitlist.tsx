...
/** The person leaves a professional's waitlist from the link in their email. */
export function LeaveWaitlist() {
  const t = useTranslations("Waitlist.leave");
    ...
    <div className="container mx-auto max-w-xl px-4 py-16">
      <div className="space-y-5 rounded-2xl border border-border/60 bg-card p-8 text-center">
        {state === "done" ? (
          ...
          <Hourglass className="mx-auto h-10 w-10 text-primary" aria-hidden="true" />
        )}
