...
export async function POST(req: NextRequest) {
  try {
    ...
    // Motif is strictly optional now (client request §2): the professional can
    // record the meeting without picking a reason.
    ...
    // Only validate the motif against the known catalogue when one is provided.
